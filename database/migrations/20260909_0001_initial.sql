-- ============================================================================
-- Migración: 20260909_0001_initial
-- ============================================================================
-- Crea el esquema inicial completo. Es idéntico en contenido a schema.sql
-- (generado desde ese archivo). Envuelve todo en una transacción y registra
-- la aplicación en schema_migrations al final.
--
-- Para nuevas instalaciones: correr esta migración crea toda la base.
-- Para instalaciones existentes: update.js verifica en schema_migrations si
-- ya está aplicada y salta.
-- ============================================================================
...
-- Registro de aplicación. El checksum se llena desde update.js al aplicar
-- (calculado sobre el contenido del archivo).
INSERT INTO schema_migrations (id, template_version_when_applied, checksum)
VALUES ('20260909_0001_initial', '1.2.0', 'CALCULATED_BY_UPDATE_SCRIPT');
